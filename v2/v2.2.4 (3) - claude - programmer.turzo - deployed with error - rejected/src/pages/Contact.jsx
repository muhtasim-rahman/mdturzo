// Contact.jsx — v2.2.4
// Contents cleared — full redesign planned for v2.6.0
  ...
  return (
    <>
      ...
      <div style={{minHeight:'60vh',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',gap:'1rem',paddingBlock:'4rem'}}>
        ...
        <h1 style={{fontFamily:'var(--font-display)',fontSize:'clamp(1.5rem,4vw,2.5rem)',fontWeight:800,color:'var(--text-primary)',textAlign:'center'}}>Contact page coming soon</h1>
        <p style={{color:'var(--text-secondary)',fontSize:'.9rem',textAlign:'center',maxWidth:400}}>
          Full redesign in progress — will be available in v2.6.0.
        </p>
      </div>
    </>
  )
