...
// ScrollToTop: scrolls to top on route change; also handles same-page link clicks
function ScrollToTop() {
  ...
  // Same-page navigation: if clicking a link that points to current page, scroll to top without reload
  useEffect(() => {
    const handleClick = (e) => {
      ...
      if (!href) return
      // Internal same-page link (pathname matches current, no hash or same origin path)
      try {
        ...
        // relative path; if it equals current pathname, scroll to top
