      ...
      <motion.div
        ...
        <div className="p-4 border-b border-[var(--border-color)]">
          <div className="desktop-search-field">
            ...
            />
            {query && (
              <button onClick={() => setQuery('')} className="desktop-search-clear" aria-label="Clear search">
                <FontAwesomeIcon icon={faXmark} className="text-xs" />
              </button>
            )}
            <button onClick={onClose} className="desktop-search-close" aria-label="Close search">
              <FontAwesomeIcon icon={faXmark} className="text-xs" />
            </button>
          </div>
        </div>
