...
// WaveIcon replaced with Material Symbols waving_hand in v2.2.5
...
.hgreet-icon-ms{font-size:1.05em;color:#F59E0B;flex-shrink:0;position:relative;top:2px;vertical-align:middle}
        ...
        <div className="hinner">
          ...
          <div className="hcontent">
            <div className="hgreet hup" style={{'--d':'0ms'}}>
              ...
              <span className="material-symbols-outlined hgreet-icon-ms" aria-hidden="true">waving_hand</span>
