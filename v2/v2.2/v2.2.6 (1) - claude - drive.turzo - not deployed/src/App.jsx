// ============================================================
// APP.JSX — v2.2.6
// REMOVED: SectionSnap (auto-scroll-to-section after scroll stops)
// All other logic unchanged from v2.2.5
// ============================================================
  ...
  return (
    <HelmetProvider>
      <ErrorBoundary>
        <ClickEffect />
        <ScrollToTop />
        {/* SectionSnap REMOVED in v2.2.6 — no more auto-scroll-to-section */}
        <PageProgress />
        <ToastContainer />
        <AnimatedRoutes />
      </ErrorBoundary>
