// Process.jsx -- v2.2.8
// Replaces "How I Work" 6-step process with a premium "My Setup" section.
// Design: clean two-panel layout — left text + tool list, right a stylised
//         code-editor / workspace mockup card. Minimal color, responsive.
...
const TOOLSET = [
  ...
  { icon: faFigma,      label: 'Figma',         sub: 'UI & prototyping',       color: '#EC4899' },
  { icon: faGithub,     label: 'Git & GitHub',  sub: 'Version control',        color: '#94A3B8' },
  { icon: faTerminal,   label: 'Terminal',      sub: 'CLI & scripting',        color: '#22C55E' },
  { icon: faGlobe,      label: 'React + Vite',  sub: 'Frontend stack',         color: '#06B6D4' },
  { icon: faDatabase,   label: 'Firebase',      sub: 'Backend & auth',         color: '#F59E0B' },
  { icon: faPalette,    label: 'Adobe Suite',   sub: 'Graphics & editing',     color: '#A855F7' },
  { icon: faLayerGroup, label: 'Tailwind CSS',  sub: 'Utility-first styling',  color: '#10B981' },
]

const PRINCIPLES = [
  'Clean, readable code over clever hacks',
  'Mobile-first, accessibility-aware design',
  'Ship fast, iterate based on real feedback',
  'Document everything for future self',
]

// Fake code lines for the editor mockup
const CODE_LINES = [
  { indent:0, tokens:[{t:'keyword',v:'import'},{t:'plain',v:' { '},{t:'fn',v:'useState'},{t:'plain',v:', '},{t:'fn',v:'useEffect'},{t:'plain',v:' } '},{t:'keyword',v:'from'},{t:'str',v:"'react'"}] },
  ...
  { indent:0, tokens:[] },
  { indent:1, tokens:[{t:'fn',v:'useEffect'},{t:'plain',v:'(() => {'}] },
  { indent:2, tokens:[{t:'obj',v:'document'},{t:'plain',v:'.'},{t:'fn',v:'title'},{t:'plain',v:' = '},{t:'str',v:"'Muhtasim Rahman'"}] },
      ...
      <div className="container-xl">
        ...
        <motion.div className="text-center mb-10"
          ...
          <p className="text-[var(--text-secondary)] mt-2 text-sm max-w-sm mx-auto">
            Tools and habits that keep my projects clean, fast and well-delivered.
          </p>
        </motion.div>
        ...
        <div className="mws-grid">
          ...
          <motion.div className="mws-right"
            ...
            <div className="mws-editor-stats">
              {[
                { icon: faRocket, label: 'Fast deploys', value: 'Vercel / Firebase' },
                { icon: faCode,   label: 'Version ctrl', value: 'Git + GitHub'      },
              ].map(s => (
