...
function ProjectCard({p,i}){
  ...
  return(
    <motion.div className="card group flex flex-col overflow-hidden hover:border-[var(--accent-primary)] transition-all duration-300"
      ...
      <div className="p-4 flex flex-col gap-2.5 flex-1">
        ...
        <h3 className="font-display font-bold text-[var(--text-primary)] leading-snug group-hover:text-[var(--accent-primary)] transition-colors duration-200 line-clamp-2 text-sm">{p.title}</h3>
