// AboutMini.jsx — v2.2.3
// Changes: use muhtasim-about.webp, larger PC image, 6th card as "Read Full Story" button
...
export default function AboutMini() {
  ...
  return (
    <section className="section" id="about-mini">
          ...
          <motion.div className="relative flex justify-center"
            ...
            <div className="relative w-72 sm:w-80 lg:w-96">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[3/4] border border-[var(--border-strong)] bg-[var(--bg-surface-2)] shadow-[var(--shadow-xl)]">
                ...
                {/* Dark mode: dark gradient; Light mode: light gradient */}
                <div className="absolute bottom-0 left-0 right-0 h-1/2 pointer-events-none dark-grad"
                  style={{background:'linear-gradient(to top,rgba(2,6,23,.85),transparent)'}}/>
                <div className="absolute bottom-0 left-0 right-0 h-1/2 pointer-events-none light-grad"
                  style={{background:'linear-gradient(to top,rgba(225,232,242,.88),transparent)'}}/>
                <style>{`
                  [data-theme=dark]  .dark-grad  { display:block }
                  [data-theme=dark]  .light-grad { display:none  }
                  [data-theme=light] .dark-grad  { display:none  }
                  [data-theme=light] .light-grad { display:block }
                `}</style>
