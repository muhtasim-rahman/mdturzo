// Hero.jsx -- v2.2.9
// CHANGES:
//   * "Muhtasim Rahman" in single span (white), "(Turzo)" in primary color, absolute positioned below-right on large screens
//   * Large screen: min-height set explicitly; small/mobile: unchanged
//   * `--` dashes replaced with em dash `—`
//   * Mobile: "Download" text hidden, both buttons in same row
//   * Assalamu Alaikum greeting: waving_hand icon color fixed for light mode
//   * Hero image bottom gradient starts 5px below image
//   * Margin/alignment fix: left content uses same container padding as rest of site
...
/* Large screen: explicit min-height */
...
/* v2.2.9: greeting color fix — icon uses accent color in both modes */
...
[data-theme=light] .hgreet-salam,[data-theme=light] .hgreet-salam{color:var(--accent-primary)}
.hgreet-icon{color:#F59E0B}
[data-theme=light] .hgreet-icon{color:var(--accent-primary)}
.hgreet-rest{color:var(--text-primary);font-family:var(--font-mono);font-weight:500;font-size:.82rem;opacity:.9}

/* name */
.hname{font-size:clamp(2.2rem,4.5vw,4.2rem);font-weight:800;line-height:1.02;letter-spacing:-.03em;font-family:var(--font-display)}
...
/* v2.2.9: "Muhtasim Rahman" both white, "(Turzo)" primary color, absolute below-right on large screens */
.hname-main{color:var(--text-primary);white-space:nowrap}
.hname-turzo-wrap{
  /* Large screens: absolute positioning below-right of the name line */
  position:absolute;
  right:0;
  top:100%;
  margin-top:-.1em;
...
/* v2.2.9: mobile — hide "Download" text, keep both buttons in same row */
@media(max-width:479px){
  .hcta{flex-wrap:nowrap}
...
/* v2.2.9: gradient starts 5px below image bottom (negative bottom offset) */
.himg-frame::after{
  content:'';position:absolute;z-index:2;pointer-events:none;
  bottom:-5px;left:0;right:0;height:38%;
...
/* v2.2.9: on mobile/tablet, Turzo becomes inline below name */
@media(max-width:899px){
  .hname-turzo-wrap{
    position:static;
    display:block;
        ...
        <div className="hero-inner">
          ...
          <div className="hcontent">
            <div className="hgreet hup" style={{'--d':'0ms'}}>
              ...
              <span
                className="material-symbols-outlined hgreet-icon"
                style={{ fontSize: '1.1em', verticalAlign: 'middle', lineHeight: 1, display: 'inline-flex', alignItems: 'center' }}
                aria-hidden="true">
                waving_hand
              </span>
            ...
            <h1 className="hname" aria-label="Muhtasim Rahman (Turzo)">
              <span className="hname-line">
                <span className="hname-in" style={{'--d':'70ms'}}>
                  ...
                  {/* v2.2.9: absolute on large, inline on mobile */}
                  <span className="hname-turzo-wrap">(Turzo)</span>
                </span>
              </span>
            </h1>
