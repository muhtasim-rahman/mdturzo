// About.jsx — v2.2.5
// Task 9: Content cleared — placeholder until v2.3.0 full build
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="About Muhtasim Rahman — full page coming soon." />
      </Helmet>
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
            Full about page is under construction. It will include my full story, timeline, tools, and more.
          </p>
          <div style={{ marginTop: '1.5rem', padding: '0.75rem 1rem', borderRadius: '10px', background: 'var(--bg-surface-2)', border: '1px solid var(--border-color)' }}>
            <p style={{ fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>
              Planned for <strong style={{ color: 'var(--text-secondary)' }}>v2.3.0</strong> release
            </p>
          </div>
        </div>
      </div>
