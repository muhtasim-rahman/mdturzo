...
// CHANGES:
//   * Removed "Progress XX%" caption above progress bars
//     (just the bar remains, no label/percentage header)
// ============================================================
  ...
  return (
    <section className="section" id="about-goals" ref={sectionRef}>
      ...
      <style>{`
        ...
        /* Progress bar — no caption, just the track */
        .abg-progress-wrap { margin-top: auto; }
        .abg-progress-track {
