...
// Hero: New left layout (distinct from home hero).
// Gradient: full section bottom-to-top (not image-only),
// stays below left content on all screen sizes.
// ============================================================
...
export default function AboutHero({ age, settings }) {
  return (
    <section className="ab-hero" id="about-hero" aria-label="About Hero">
      ...
      {/* Full-section bottom gradient — below left content */}
      <div className="ab-hero-grad" aria-hidden="true" />

      <div className="ab-hero-inner">
        {/* LEFT — redesigned layout */}
        <motion.div className="ab-hero-left"
          ...
          <motion.div variants={fadeUp} className="ab-hero-identity">
            <span className="ab-hero-eyebrow">— Getting to know me</span>
            <h1 className="ab-hero-h1">
              Muhtasim
              <span className="ab-hero-name-line">
                Rahman
                <span className="ab-hero-nick">Turzo</span>
              </span>
            </h1>
            <div className="ab-hero-role-chip">
          ...
          {/* Divider + age badge */}
          <motion.div variants={fadeUp} className="ab-hero-footer">
            <span className="ab-age-badge">Age {age}</span>
            <span className="ab-footer-sep" />
            <span className="ab-footer-text">Nilphamari, Bangladesh</span>
          </motion.div>
        </motion.div>
      ...
      <style>{`
        ...
        /* Full-section gradient — bottom to top, full width, same on all sizes */
        .ab-hero-grad {
        ...
        /* Identity */
        .ab-hero-identity { display: flex; flex-direction: column; gap: .5rem; }
        .ab-hero-eyebrow {
        ...
        .ab-fact-pill {
          display: inline-flex; align-items: center; gap: .55rem;
          padding: .42rem .75rem; border-radius: var(--radius-md);
          background: var(--bg-surface); border: 1px solid var(--border-color);
        ...
        /* No image-specific gradient — gradient now lives at section level (.ab-hero-grad) */
        .ab-hero-img {
        ...
        @media (max-width: 900px) {
          ...
          .ab-hero-facts { margin-inline: auto; justify-items: center; }
          .ab-hero-cta, .ab-hero-footer { justify-content: center; }
          .ab-hero-img-box {
        ...
        @media (max-width: 480px) {
          ...
          .ab-hero-facts { grid-template-columns: 1fr 1fr; max-width: 100%; }
        }
      `}</style>
    </section>
  )
