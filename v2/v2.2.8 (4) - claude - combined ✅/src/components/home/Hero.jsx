// Hero.jsx -- v2.2.7
// CHANGES:
//   * Floating tech icons + related files/code REMOVED entirely
//   * ResizeObserver for image height REMOVED -- new fixed-layout approach
//   * 12+ breakpoints for perfect sizing across all devices
//   * New minimal hero: subtle dot-grid texture, bottom-to-top gradient, rising particles
//   * Image: fixed size per breakpoint, never grows infinitely
            ...
            <h1 className="hname" aria-label="Muhtasim Rahman (Turzo)">
              <span className="hname-line">
                <span className="hname-in" style={{'--d':'70ms'}}>
                  Muhtasim <span className="hname-acc">Rahman</span><span className="hname-turzo"> (Turzo)</span>
                </span>
              </span>
            </h1>
