          ...
          <motion.div className="relative flex justify-center w-full"
            ...
            <div className="relative w-72 sm:w-80 lg:w-96">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[3/4] border border-[var(--border-strong)] bg-[var(--bg-surface-2)] shadow-[var(--shadow-xl)]">
                ...
                {/* Dark mode: dark gradient overlay for text readability */}
                <div className="absolute bottom-0 left-0 right-0 h-1/2 pointer-events-none"
                  style={{background:'linear-gradient(to top,rgba(2,6,23,.85),rgba(2,6,23,.3) 50%,transparent)'}}/>
                {/* Light mode: subtle transparent gradient only */}
                <div className="absolute bottom-0 left-0 right-0 h-1/3 pointer-events-none hidden [data-theme=light] &:block"
                  style={{background:'linear-gradient(to top,rgba(15,23,42,.55),transparent)'}}/>
                <style>{`[data-theme=light] .about-img-overlay{background:linear-gradient(to top,rgba(15,23,42,.55),transparent) !important}`}</style>
