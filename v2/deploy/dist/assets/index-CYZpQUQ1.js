 ...
 */var W=u;function Sa(t,r){return t===r&&(t!==0||1/t===1/r)||t!==t&&r!==r}var Ta=typeof Object.is=="function"?Object.is:Sa,Ea=W.useState,Aa=W.useEffect,Ca=W.useLayoutEffect,_a=W.useDebugValue;function za(t,r){var a=r(),n=Ea({inst:{value:a,getSnapshot:r}}),s=n[0].inst,o=n[1];return Ca(function(){s.value=a,s.getSnapshot=r,_e(s)&&o({inst:s})},[t,a,r]),Aa(function(){return _e(s)&&o({inst:s}),t(function(){_e(s)&&o({inst:s})})},[t]),_a(a),a}function _e(t){var r=t.getSnapshot;t=t.value;try{var a=r();return!Ta(t,a)}catch{return!0}}function Pa(t,r){return r()}var Ra=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?Pa:za;Ht.useSyncExternalStore=W.useSyncExternalStore!==void 0?W.useSyncExternalStore:Ra;Ft.exports=Ht;var La=Ft.exports;/**
 * @license React
