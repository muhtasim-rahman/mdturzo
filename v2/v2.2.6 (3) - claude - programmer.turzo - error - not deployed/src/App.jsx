// ============================================================
// APP.JSX — v2.2.6
// Bug fix: SectionSnap and auto-scroll FULLY REMOVED per user request.
// Only ScrollToTop remains (on route change, instant).
// Added: smooth scroll CSS + improved scroll-padding in html.
// Bug fix: CLICKABLE_SELECTOR now includes nav link classes for click effects.
// ============================================================
...
// Bug fix: added .top-nav-link, .float-nav-link, [data-click-fx="true"] explicitly
// so nav item clicks trigger the ripple/burst effect properly
...
// Scroll to top on route change (instant, not smooth — smooth is for in-page)
  ...
  return (
    <HelmetProvider>
      <ErrorBoundary>
        <ClickEffect />
        <ScrollToTop />
        {/* SectionSnap REMOVED — no auto-scroll/snap per v2.2.6 */}
        <PageProgress />
        <ToastContainer />
        <AnimatedRoutes />
      </ErrorBoundary>
