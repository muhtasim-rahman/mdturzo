...
import FeedSkeleton, { BlogDetailSkeleton, PostDetailSkeleton } from './components/skeletons/FeedSkeleton.jsx'
...
function RouteBoundary({ children, layout = 'blank', initialPending, onReady }) {
  const fallback = initialPending ? <PageLoader fullscreen /> : (() => {
    switch (layout) {
      ...
      case 'list':          return <FeedSkeleton />
      case 'blog-detail':   return <BlogDetailSkeleton />
      case 'post-detail':   return <PostDetailSkeleton />
    ...
    <AnimatePresence mode="wait" initial={false}>
      <Routes location={location} key={location.pathname}>
        <Route element={<Layout />}>
          ...
          <Route path="/blogs/:slug"    element={routeElement(<BlogDetail />, 'blog-detail')} />
          <Route path="/posts"          element={routeElement(<Posts />, 'list')} />
          <Route path="/posts/:slug"    element={routeElement(<PostDetail />, 'post-detail')} />
