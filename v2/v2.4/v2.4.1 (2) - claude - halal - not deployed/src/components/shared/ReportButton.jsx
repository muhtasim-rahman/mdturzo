...
export default function ReportButton({ contentType, contentId, className = '' }) {
  ...
  return (
    <>
      <button
        onClick={handleOpen}
        className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm text-[var(--text-tertiary)] hover:text-red-400 hover:bg-red-400/8 border border-[var(--border-color)] hover:border-red-400/30 transition-all ${className}`}
        title="Report">
