...
export default function Hero({settings,settingsLoading}){
  ...
  const proj=settings?.projectCount??0
...
.hero-inner{
  ...
  padding-top:calc(var(--navbar-h) + clamp(.5rem,1.5vh,1.25rem));
...
/* xs: <480 */
@media(max-width:479px){
  .hero-inner{padding-top:calc(var(--navbar-h) + 1rem);padding-bottom:2.5rem;gap:1.5rem}
