...
import {
  ...
  faCalendar, faDownload, faEye, faPrint, 
...
const EXP_STATS = (s) => [
  ...
  { val: s?.projectCount > 0 ? `${s.projectCount}+` : (s ? '0' : '…'), lbl: 'Projects',      c: '#10B981', icon: faRocket  },
]
  ...
  return (
    <section className="section section-alt" id="about-story">
            ...
            {cvOk && (
              <div className="ast-cv-card">
                <div className="ast-cv-top">
                  <div className="ast-cv-badge">
                    <img src="/logo.webp" alt="Muhtasim Rahman" className="ast-cv-avatar" />
                  </div>
                  <div>
      ...
      <style>{`
        ...
        .ast-journey-title {
          font-size: .85rem; font-weight: 700; margin-bottom: .28rem; margin-top: .4rem;
        }
