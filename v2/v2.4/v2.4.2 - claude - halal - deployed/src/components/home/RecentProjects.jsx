// RecentProjects.jsx — v2.4.2
// Updated:
//   - PC (≥1024px): 6 cards shown (3 cols × 2 rows)
//   - Tablet (640–1023px): 4 cards shown (2 cols × 2 rows)
//   - Mobile (<640px): 3 cards shown (1 col × 3 rows)
//   - Dynamic count from Supabase is_featured=true
//   - Static fallback if no featured projects
...
const STATIC_FALLBACK = [
  ...
  { id: 'ufmt',      slug: 'ufmt-ssc26',         title: 'FMT Tracker Pro — SSC-26',      short_description: 'Smart merit tracking dashboard for SSC-26 students powered by Google Sheets.',                      thumbnail_url: 'https://i.ibb.co.com/2YqYxGHz/ufmt-ssc26.webp',                         github_link: 'https://github.com/muhtasim-rahman/UFMT-SSC26',         live_link: 'https://muhtasim-rahman.github.io/UFMT-SSC26/', tags: ['Education', 'Sheets', 'PWA'],     category: 'Education',    is_featured: true, featured_order: 3, views_count: 512, likes_count: 87 },
        ...
        <div key={i} className="bg-[var(--bg-surface)] rounded-2xl overflow-hidden border border-[var(--border-color)]">
          ...
          <div className="p-4 space-y-2.5">
            ...
            <div className="flex gap-1.5">
              <div className="sk h-4 w-14 rounded-md" style={{ animationDelay: `${i * 0.06 + 0.08}s` }} />
              <div className="sk h-4 w-20 rounded-md" style={{ animationDelay: `${i * 0.06 + 0.12}s` }} />
            </div>
            <div className="sk h-3.5 w-full rounded" style={{ animationDelay: `${i * 0.06 + 0.16}s` }} />
            <div className="sk h-3.5 w-2/3 rounded" style={{ animationDelay: `${i * 0.06 + 0.2}s` }} />
          </div>
        </div>
      ))}
    </div>
...
export default function RecentProjects() {
  ...
  // Responsive visible count: 6 / 4 / 3
  useEffect(() => {
    const update = () => {
