...
// Task 11: Stay Connected block center alignment
// Task 12: Let's Collaborate card data-click-fx ensured
  ...
  return (
    <>
      ...
      <div className="nf-sc-wrap">
        <div className="nf-sc" style={{marginInline:'auto'}}>
          {/* ── Left: heading ── */}
        ...
        <div className="nf-inner">
          ...
          <div className="nf-main">
            ...
            <div className="nf-contact-col">
              ...
              {/* Contact card */}
              <Link to="/contact" className="nf-contact-card" data-click-fx="true">
      ...
      <style>{`
        ...
        /* v2.3.6 fix: .nf-footer used to ALSO carry "padding: 0 1.75rem"
           which stacked on top of .nf-inner's own padding-inline below,
           double-padding the content and misaligning it against the
           navbar (which only pads once). .nf-inner is now the single
           source of horizontal inset, matching .navbar-inner exactly. */
        .nf-inner { max-width: 1120px; margin: 0 auto; padding-inline: clamp(1rem, 4vw, 1.75rem); }
        @media (min-width: 1440px) { .nf-sc { padding-inline: 0; } }
