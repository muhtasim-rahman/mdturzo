...
// CHANGES:
//   * Breadcrumb moved to About.jsx sticky bar (removed here)
//   * Full-section bottom-to-top gradient (same style as home Hero)
//   * hero-back.webp keeps same home gradient treatment (no rounded frame on mobile/tablet)
//   * Left content minimal, clean, responsive
//   * Unique 2-col layout: editorial left + tall right image panel
//   * Top padding accounts for navbar + 34px breadcrumb bar
// ============================================================
    ...
    <section className="abh-section" id="about-hero" aria-label="About Hero">
      ...
      <div className="abh-inner">
        ...
        <motion.div className="abh-left"
          ...
          {/* Chapter badge */}
          <motion.div variants={fadeUp} className="abh-chapter">
            <span className="abh-ch-num">01</span>
            <span className="abh-ch-slash">/</span>
            <span className="abh-ch-lbl">About Me</span>
          </motion.div>
        ...
        <motion.div className="abh-right"
          ...
          <div className="abh-img-wrap">
            ...
            <div className="abh-badge">
              <span className="abh-badge-val">{age}</span>
              <span className="abh-badge-lbl">years old</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <style>{`
        ...
        .abh-section {
          ...
          /* account for: navbar (var(--navbar-h)) + breadcrumb bar (34px) */
          padding-top: calc(var(--navbar-h) + 34px);
        }
        ...
        .abh-inner {
          ...
          min-height: calc(100dvh - var(--navbar-h) - 34px);
        }
        ...
        .abh-fact-lbl  { font-size: .6rem; color: var(--text-tertiary); font-family: var(--font-mono); text-transform: uppercase; letter-spacing: .04em; }
        ...
        .abh-badge {
          ...
          padding: .6rem .9rem; border-radius: var(--radius-xl);
        ...
        @media (max-width: 900px) {
          ...
          .abh-badge { bottom: 22%; left: auto; right: 2%; }
          .abh-img   { border-radius: 0; } /* NO rounded frame on tablet/mobile */
        }
