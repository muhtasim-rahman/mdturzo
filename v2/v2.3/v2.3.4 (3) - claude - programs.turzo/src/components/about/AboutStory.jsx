...
// "Who I Am" section — fresh, clean rebuild.
// New layout: horizontal intro bar + 3-col details + journey + stats
// Title changed from "My Story" to "Who I Am"
// ============================================================
  ...
  return (
    <section className="section section-alt" id="about-story">
      <div className="container-xl">
        ...
        <div className="ast-grid">
          ...
          <motion.div className="ast-col"
            ...
            <div className="ast-info-card card">
            ...
            {cvOk && (
              <div className="ast-cv-card card">
                <div className="ast-cv-top">
                  <div className="ast-cv-badge">CV</div>
                  <div>
          ...
          <motion.div className="ast-col"
            ...
            <blockquote className="ast-quote card">
      ...
      <style>{`
        ...
        /* Info card */
        .ast-info-card { padding: 1.2rem 1.35rem; }
        .ast-card-title {
        ...
        .ast-info-row {
          display: flex; align-items: center; gap: .65rem;
          padding: .38rem 0; border-bottom: 1px solid var(--border-color);
        }
        ...
        /* CV card */
        .ast-cv-card { padding: 1.1rem 1.35rem; }
        ...
        .ast-journey-line {
          ...
          background: var(--border-color); margin: .35rem 0;
        }
        .ast-journey-body { padding-bottom: 1.25rem; flex: 1; }
        .ast-journey-title {
          font-size: .85rem; font-weight: 700; margin-bottom: .28rem; margin-top: .5rem;
        }
