...
// CHANGES:
//   * Removed floating age badge (absolute div)
//   * 'Turzo' badge nudged 2px up, 3px left
//   * Removed extra 34px breadcrumb padding from section top
// ============================================================
...
export default function AboutHero({ settings }) {
  ...
  return (
    <section className="abh-section" id="about-hero" aria-label="About Hero">
      ...
      {/* Full-section bottom-to-top gradient */}
      ...
      <style>{`
        ...
        .abh-section {
          ...
          /* account for navbar only — breadcrumb bar removed */
        ...
        .abh-inner {
          ...
          padding-top: clamp(.75rem, 2.5vh, 2rem);
        ...
        /* Scroll hint */
        .abh-scroll-hint {
          display: flex; align-items: center; gap: .55rem; padding-top: .1rem;
        }
        .abh-scroll-line { width: 28px; height: 1px; background: var(--border-strong); }
        .abh-scroll-icon {
