// ============================================================
// AboutSkills.jsx — v2.3.3
// CHANGES:
//   * Shimmer (shining) animation added to all progress bars
//     — identical to home page Skills section
// ============================================================
    ...
    <div className="absk-bar-row">
      ...
      <div className="absk-bar-track">
        <motion.div
          ...
          style={{ '--c': color, background: `linear-gradient(90deg, ${color}cc, ${color})`, boxShadow: `0 0 8px ${color}55` }}
          initial={{ width: 0 }}
              ...
              {tab === 'design' && (<>
                <div className="absk-bars-col">
                  {DESIGN_SKILLS.map((sk, i) => (
                    <SkillBar key={sk.name} name={sk.name} pct={sk.pct} color={sk.color} index={i} inView={panelInView} />
                  ))}
                </div>
                <div className="absk-note-card card">
