      ...
      <style>{`
        ...
        .abc-card::before {
          ...
          background: linear-gradient(
            105deg,
            transparent 40%,
            color-mix(in srgb, var(--soc, var(--accent-primary)) 8%, transparent) 50%,
            transparent 60%
          );
        ...
        .abc-card:hover {
          ...
          border-color: color-mix(in srgb, var(--soc, var(--accent-primary)) 45%, var(--border-color));
          background: color-mix(in srgb, var(--soc, var(--accent-primary)) 4%, var(--bg-surface));
        }
        .abc-card:hover::before { transform: translateX(100%); }
        .abc-card:hover::after  { transform: scaleY(1); }
        [data-theme=light] .abc-card:hover {
          box-shadow: 0 6px 18px rgba(0,0,0,.08);
        }
        .abc-card:active { transform: scale(.97); transition-duration: .1s; }
        ...
        .abc-card:hover .abc-name { color: var(--soc, var(--accent-primary)); }
        .abc-handle {
        ...
        .abc-arrow {
          ...
          color: var(--text-tertiary); opacity: .28; flex-shrink: 0;
