  ...
  return (
    <section className="section" id="about-goals" ref={sectionRef}>
        ...
        <div className="abg-grid">
          {GOALS.map(({ period, subtitle, color, icon, items, pct }, gi) => (
            <motion.div key={period}
              ...
              {/* Color accent: left border via CSS var */}
              <div className="abg-body">
                {/* Left accent line using border-left inline */}
                <div className="abg-card-accent" style={{ background: color }} />
                {/* Header */}
      ...
      <style>{`
        ...
        .abg-body { padding: 1.5rem 1.5rem 1.5rem 1.75rem; display: flex; flex-direction: column; flex: 1; }
