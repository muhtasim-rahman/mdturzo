    ...
    <section className="section section-alt" id="about-skills">
      ...
      <style>{`
        ...
        @media (max-width: 560px) {
          .absk-tabs { width: 100%; border-radius: var(--radius-lg); }
          .absk-tab  { flex: 1 0 auto; justify-content: center; padding: .48rem .8rem; font-size: .76rem; }
        }
