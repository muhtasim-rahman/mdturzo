// AboutMini.jsx -- v2.4.5
// Updated: project count now comes from real projects table via useSiteSettings
...
export default function AboutMini() {
  ...
  const projCount = settings?.projectCount ?? 0
  return (
          ...
          <motion.div className="relative flex justify-center"
            ...
            <div className="relative w-72 sm:w-80 lg:w-96">
              ...
              <motion.div className="absolute -left-6 bottom-16 card px-3 py-2 shadow-[var(--shadow-lg)] text-center min-w-[78px]"
                ...
                <p className="text-xl font-display font-extrabold text-[#10B981]">{projCount > 0 ? `${projCount}+` : '—'}</p>
