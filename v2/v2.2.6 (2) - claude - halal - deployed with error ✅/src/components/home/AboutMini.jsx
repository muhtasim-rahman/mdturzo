  ...
  return (
    <section className="section section-alt" id="about-mini">
      <div className="container-xl">
        {/* Task 13: grid is centered — using justify-items:center and mx-auto on the grid wrapper */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center justify-items-center mx-auto">
          {/* Image — larger on PC */}
