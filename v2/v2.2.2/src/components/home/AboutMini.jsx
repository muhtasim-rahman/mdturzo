// AboutMini.jsx — v2.2.2
import { Link } from 'react-router-dom'
import { motion } from 'framer-motion'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faLocationDot, faGraduationCap, faHeart, faArrowRight, faLanguage, faLaptopCode } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div className="relative flex justify-center"
            ...
            <div className="relative w-64 sm:w-72">
              <div className="absolute inset-0 translate-x-4 translate-y-4 rounded-2xl border-2 border-[var(--accent-primary)] opacity-20"/>
              <div className="relative rounded-2xl overflow-hidden aspect-[3/4] border border-[var(--border-strong)] bg-[var(--bg-surface-2)] shadow-[var(--shadow-xl)]">
                ...
                <img src="/hero-back.webp" alt="Muhtasim Rahman"
          ...
          <motion.div className="flex flex-col gap-5"
            ...
            <motion.div variants={up}>
              <Link to="/about" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm
                bg-[var(--accent-primary)] hover:bg-[var(--accent-hover)] text-white
                shadow-md hover:shadow-[var(--shadow-glow)] transition-all duration-200 active:scale-[.97] group">
                Read Full Story
