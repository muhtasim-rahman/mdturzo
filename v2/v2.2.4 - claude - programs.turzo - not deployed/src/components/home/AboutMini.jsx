        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div className="relative flex justify-center"
            ...
            <div className="relative w-72 sm:w-80 lg:w-96">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[3/4] border border-[var(--border-strong)] bg-[var(--bg-surface-2)] shadow-[var(--shadow-xl)]">
                <div className="absolute inset-0 dark-grad-overlay" style={{background:'linear-gradient(135deg,#0F172A,#1E293B 60%,#1E3A8A)'}}/>
                <style>{`[data-theme=light] .dark-grad-overlay{background:linear-gradient(135deg,#e0eaff,#f0f4ff 60%,#dbeafe)!important}`}</style>
          ...
          <motion.div className="flex flex-col gap-5"
            ...
            <motion.div variants={up} className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              <Link to="/about"
                className="group flex items-start gap-2.5 p-3 rounded-lg border transition-all duration-200"
                style={{
