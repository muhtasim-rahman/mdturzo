...
const TOOLSET = [
  ...
  { icon: faGlobe,      label: 'HTML / CSS / JS', sub: 'Core stack',            color: '#F59E0B' },
  { icon: faTerminal,   label: 'Firebase',        sub: 'Backend & hosting',     color: '#F97316' },
  { icon: faDatabase,   label: 'Google Sheets',   sub: 'Lightweight backend',   color: '#10B981' },
  { icon: faFigma,      label: 'Figma',           sub: 'UI & prototyping',      color: '#EC4899' },
  { icon: faPalette,    label: 'Adobe Suite',     sub: 'Design & editing',      color: '#A855F7' },
  { icon: faLayerGroup, label: 'Tailwind CSS',    sub: 'Utility-first styling', color: '#06B6D4' },
]

const PRINCIPLES = [
  'Clean, readable code — not clever hacks',
  'Mobile-first, accessibility-aware design',
  'Ship working features, iterate from feedback',
      ...
      <div className="container-xl">
        ...
        <motion.div className="text-center mb-10"
          ...
          <p className="text-[var(--text-secondary)] mt-2 text-sm max-w-md mx-auto">
            Self-taught and self-driven — the tools and habits behind every project I ship.
          </p>
        </motion.div>
