// =============================================================================
// NAVBAR — v1.4.2
// Fixed: mobile hamburger, alignment, mobile theme toggle in bar
// =============================================================================
...
const Navbar = (() => {
    ...
    nav.innerHTML = `
      ...
      <div class="navbar__inner">
        ...
        <a href="/" class="navbar__logo" data-nav-link="/">
          <span class="navbar__logo-icon"><i class="fa-solid fa-code" aria-hidden="true"></i></span>
          ${_cfg.owner.displayName.split(' ')[0]}<span>.</span>
        </a>
        ...
        <div class="navbar__actions">
          ...
          <button class="navbar__icon-btn navbar__icon-btn--notif" id="navbar-notif-btn"
          ...
          <div class="navbar__mega-wrap">
            <button class="navbar__icon-btn" id="navbar-mega-btn"
                    aria-label="All pages" title="All pages">
  ...
  const updateThemeUI = (theme) => {
    ...
    if (labelEl) {
      labelEl.innerHTML = `<i class="fa-solid ${icon}" aria-hidden="true"></i> ${isDark ? 'Dark Mode' : 'Light Mode'}`;
    }
  };
  ...
  const updateAuthUI = (user) => {
    ...
    if (user) {
      ...
      authBtn.innerHTML = `<i class="fa-regular fa-user" aria-hidden="true"></i>`;
    }
  };
