...
const Utils = (() => {
  ...
  /** Dynamically load a <script> (resolves immediately if already loaded) */
  ...
  /** Dynamically inject a <link rel=stylesheet> (noop if already loaded) */
  const loadCSS = (href) => {
...
// ── Dynamic Script / CSS Loader ─────────────────────────────────────────────
  ...
  /** Dynamically load a script (returns Promise, avoids double-loading) */
  // Note: appended to Utils after initial definition — see bottom of file for export override
